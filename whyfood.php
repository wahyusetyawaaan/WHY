...
$headers[] = 'X-Location: -6.405821,106.064193';
        ...
        echo "\n";
        ulang:
        echo "\e[96m[×] Masukan No HP Anda ya bgst : ";
        ...
        if($regs->success == true) {
            ...
            if($verifs->success == true) {
                ...
                // SANTAI19
                echo "\e[96m[!] Waiting.. Reedem Voucher 20K+10k : GOFOODSANTUY:) \n";
                ...
                if($claims->success == true) 
                        {
                            ...
                            {
                                echo "\e[91m [×] Gagal Bngst !";
                                    sleep(5);
                                    echo "\n";

                                    // SANTAI11
                                        echo "\e[96m[!] Waiting.. Reedem Voucher 15K+10K : GOFOODSANS:) \n";
                                        ...
                                        if($claims1->success == true) 
                                                {
                                                    ...
                                                    {
                                                        echo "\e[91m [×] Gagal Bangst !";
                                                            sleep(5);
                                                            echo "\n";

                                                            // SANTAI08
                                                                echo "\e[96m[!] waiting.. Redeem Voucher 10K+10K : GOFOODRECEH:) \n";
                ...
                sleep(5);
                echo "\n";
                echo "\e[96m[!] Waiting... Redeem Vocher : GORIDEASOY \n";
                $data6 = '{"promo_code":"GOFOODBOBA19"}';
                ...
                sleep(5);
                echo "\n";
                echo "\e[96m[+] waiting.. Redeem Vocher : AYOGOYANGDUMANG \n";
                $data7 = '{"promo_code":"JAJANPAKAIGOPAY"}';
    ...
    {
        echo color("red","[×] Salah tolol masukin yg bener");
        echo"\n==================================\n\n";
        echo color("yellow","[!] Silahkan input lagi tod!\n");
        goto otp;
    }
                    
                } else
                    {
                        echo color("red","[×] Nomor sudah dipakai goblok!!");
                        echo"\n==================================\n\n";
                        echo color("yellow","[!] Silahkan registrasi kembali TOD!\n");
                        goto ulang;
                    }   
